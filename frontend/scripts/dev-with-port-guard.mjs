...
function runPortGuard() {
  execSync("node frontend/scripts/ensure-port-3000.mjs", {
    stdio: "inherit",
    encoding: "utf8",
  });
}
  ...
  return new Promise((resolve) => {
    const child =
      process.platform === "win32"
        ? spawn(process.env.ComSpec || "cmd.exe", ["/d", "/s", "/c", `npx next dev frontend -p ${TARGET_PORT}`], {
            stdio: ["inherit", "pipe", "pipe"],
          })
        : spawn("npx", ["next", "dev", "frontend", "-p", TARGET_PORT], {
            stdio: ["inherit", "pipe", "pipe"],
          });
