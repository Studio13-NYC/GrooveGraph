...
const RELATIONSHIP_DESCRIPTIONS: Record<RelationshipType, string> = {
  PERFORMED_BY: "A recorded track or work is performed by a band or person.",
  ...
  PLAYED_INSTRUMENT: "A person or band member played an instrument.",
  RELEASED_BY: "A release or album was released by a label.",
  ISSUED_BY_LABEL: "A work or release was issued by a label.",
  FEATURES: "A recording or release features another band or person.",
  ...
  PLAYED_ON: "A person performed on a track, album, or release.",
  MEMBER_OF: "A person is or was a member of a band.",
  CONTAINS: "A collection or release contains another work or recording.",
  COLLABORATED_WITH: "Two bands or people collaborated.",
  ...
  PARTICIPATED_IN: "A person or band participated in a performance or session.",
